...
function MakepOptions()
	...
	Window.Paint = function(self, w, h)
		...
		draw.DrawText( "Settings", 'ZS3D2DFontSuperTiny', self:GetWide() * 0.5, 8, Color(255,255,255,200), TEXT_ALIGN_CENTER )
	end
	...
	gameplay_list:AddItem(EasyLabel(Window, translate.Get"options_weapon_hud_mode") , "DefaultFontSmall", color_white)
	...
	gameplay_list:AddItem(EasyLabel(Window, translate.Get"options_beatset_human"), "DefaultFontSmall", color_white)
	local dropdown = vgui.Create("DComboBox", Window)
	dropdown:SetMouseInputEnabled(true)
	...
	gameplay_list:AddItem(EasyLabel(Window, translate.Get"options_beatset_zombie"), "DefaultFontSmall", color_white)
	local dropdown = vgui.Create("DComboBox", Window)
	dropdown:SetMouseInputEnabled(true)
	for setname in pairs(GAMEMODE.Beats) do
	...
	gameplay_list:AddItem(EasyLabel(Window, "Prop rotation snap angle", "DefaultFontSmall", color_white))
