...
LANGUAGE.ars_discount                               = "%d discount for buying between waves!"
...
LANGUAGE.mm_pm_messg                               = "You've changed your desired player model to %d"
